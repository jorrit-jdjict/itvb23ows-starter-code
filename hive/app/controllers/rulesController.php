...
class rulesController
{
    ...
    public function slide($from, $to)
    {
        ...
        if ((!isset($this->boardComponent[$common[0]]) || !$this->boardComponent[$common[0]]) &&
            (!isset($this->boardComponent[$common[1]]) || !$this->boardComponent[$common[1]]) &&
            (!isset($this->boardComponent[$from]) || !$this->boardComponent[$from]) &&
            (!isset($this->boardComponent[$to]) || !$this->boardComponent[$to])
        ) {
            $slide = false;
        } else {
